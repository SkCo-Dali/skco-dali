...
const allMenuItems = [
  { title: "Inicio", url: "/index", iconClass: "", page: "overview", customIcon: "https://skcoblobresources.blob.core.windows.net/digital-assets/icons/icon-skandia/sk_casa_p.svg" },
