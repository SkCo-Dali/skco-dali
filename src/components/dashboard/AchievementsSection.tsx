      ...
      <CardHeader>
        <div className="flex items-center justify-between gap-4 flex-wrap border-0">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base md:text-lg font-semibold text-foreground">Tus logros en</h3>
            <Select value={period} onValueChange={onPeriodChange}>
              <SelectTrigger className="w-[140px] h-8 text-lg txt-primary border-0 bg-transparent">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
