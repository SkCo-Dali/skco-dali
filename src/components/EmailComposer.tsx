...
export function EmailComposer({
  ...
  const fieldColors: Record<string, { bg: string; text: string; bgDark: string; textDark: string }> = {
    firstName: { bg: "#dbeafe", text: "#1e40af", bgDark: "#1e3a8a", textDark: "#bfdbfe" }, // azul
    name: { bg: "#e5e7eb", text: "#374151", bgDark: "#374151", textDark: "#e5e7eb" }, // gris
    company: { bg: "#fef3c7", text: "#92400e", bgDark: "#78350f", textDark: "#fef3c7" }, // amarillo
    phone: { bg: "#e9d5ff", text: "#6b21a8", bgDark: "#581c87", textDark: "#e9d5ff" }, // morado
  };

  const getFieldColor = (fieldKey: string) => {
    return fieldColors[fieldKey] || { bg: "#e5e7eb", text: "#374151", bgDark: "#374151", textDark: "#e5e7eb" };
  };
