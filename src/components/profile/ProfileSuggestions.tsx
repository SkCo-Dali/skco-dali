    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Ayúdanos a mejorar Dali con tus ideas
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground text-right">
              {newSuggestion.length}/500 caracteres
            </p>
          </div>
      ...
      <div className="space-y-4">
        ...
        {profile.suggestions && profile.suggestions.length > 0 ? (
          <div className="space-y-3">
            {profile.suggestions.slice().reverse().map((suggestion) => (
          ...
          <Card className="p-8 border-border/40 border-dashed">
