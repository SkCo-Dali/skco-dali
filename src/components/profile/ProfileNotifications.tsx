    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="space-y-4">
        {notificationCategories.map((category) => {
          const prefs =
            localData.notificationPreferences?.[category.id as keyof typeof localData.notificationPreferences];
          ...
          return (
            <Card key={category.id} className="p-4 border-border/40">
              <div className="space-y-4">
                {/* Category Toggle */}
                <div className="flex items-center justify-between">
      ...
      <Card className="p-4 border-border/40 space-y-4">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">No recibir notificaciones durante este período</p>
          </div>
          <Switch
