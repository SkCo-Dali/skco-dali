...
export function CommissionsResumenTab({
  ...
  return (
    <div className="space-y-6 p-4 m-4 rounded-md bg-gray-50">
      {/* Selector de mes */}
          ...
          <Card className="relative overflow-hidden min-h-[285px]">
            <CardHeader className="pt-4">
              <Tabs defaultValue="comision" className="w-full">
                <TabsList className="grid w-[336px] grid-cols-2 bg-gray-100 rounded-full px-0 py-0 my-0 flex justify-center">
                  <TabsTrigger
                    value="comision"
