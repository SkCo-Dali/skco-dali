...
export const AdvisorResumenTab = ({ advisor }: Props) => {
  ...
  return (
    <div className="grid grid-cols-8 gap-6 p-4 border shadow-sm rounded-xl">
      {/* Left Side - Basic Info */}
      <div className="col-span-3 space-y-6 bg-[#EDFEFA] rounded-xl">
        {/* Avatar and Name */}
        <Card className="bg-transparent border-0 shadow-none">
          <CardContent className="p-4">
            <div className="flex flex-col items-center space-y-4">
              <div className="relative">
                <Avatar className="h-32 w-32 bg-gradient-to-r from-[#8FE000] to-[#00C73D]">
        ...
        {/* Basic Data Card */}
        <Card className="border-border/40 mx-4 mb-4 mt-0">
          <CardContent className="p-4">
